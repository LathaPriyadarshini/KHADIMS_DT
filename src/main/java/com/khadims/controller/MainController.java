package com.khadims.controller;
...
import com.khadims.dao.IProductDao;
import com.khadims.dao.ProductDao;
import com.khadims.model.Product;
import com.khadims.model.Register;
import com.khadims.service.IProductService;
import com.khadims.service.IRegisterService;
@Controller
...
/*
	...
	public ModelAndView saveregistration(@ModelAttribute("KHADIMS") @Valid Register registerbean,
...
*/
	...
	public ModelAndView addregistration(@ModelAttribute("KHADIMS") Register registerbean, BindingResult result) {
	...
	public ModelAndView saveproduct(@ModelAttribute("KHADIMS") Product productbean, BindingResult result) {
	...
	public ModelAndView productupdate(@ModelAttribute("KHADIMS") Product productbean, BindingResult result) {
	...
	public ModelAndView deleteproduct(@ModelAttribute("KHADIMS") Product product, BindingResult result) {
	...
	public ModelAndView editproduct(@ModelAttribute("KHADIMS") Product product, BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView viewproducts(@ModelAttribute("KHADIMS") Product productbean, BindingResult result) {
		/*
		 * Map<String, Object> model = new HashMap<String, Object>();
		 * model.put("product_list", productService.getAllProduct()); return new
		 * ModelAndView("productupdate",model);
	...
	public ModelAndView homeadmin(ModelMap model, Principal principal) {
		...
		model.addAttribute("message", "Dear Admin Welcome To Khadims.com");
	...
	public ModelAndView homeuser(ModelMap model, Principal principal) {
		String name = principal.getName();
		model.addAttribute("author", name);
		model.addAttribute("message", "Dear User Welcome To Khadims.com");
	...
	ModelAndView storeproduct(HttpServletRequest request, @RequestParam("file") MultipartFile file,
		...
		if (!file.isEmpty()) {
			try {
				...
				new File("F:/Project_Workspace_Eclipse_DT/KHADIMS/src/main/webapp/resources/images/"+ fileName)));
		...
		File oldName = new File("F:/Project_Workspace_Eclipse_DT/KHADIMS/src/main/webapp/resources/images/" + fileName);
		File newName = new File("F:/Project_Workspace_Eclipse_DT/KHADIMS/src/main/webapp/resources/images/" + p.getPid()
	...
	// request,@RequestParam("pid") String pid,@ModelAttribute("KHADIMS")
