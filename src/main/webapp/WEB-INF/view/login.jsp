...
<head>
    ...
    <meta name="description" content="Signup page created by LATHA PRIYADARSHINIP.R.">
    <meta name="author" content="LATHA PRIYADARSHINI P.R.">
 ...
 <link href="resources/bootstrap/css/bootstrap.css" rel="stylesheet">
    ...
    <center>
    <div class="container">
    <center>    <h1 id="banner"> <font color="red">Welcome to Khadims.com </font></h1> </center>  
        <form class="form-signin" name="f" action="<c:url value='j_spring_security_check'/>"
                    method="POST">
                    <h2 class="form-signin-heading"><font color="lightblue">Please sign in</font></h2>
            <table>
                <tr>
